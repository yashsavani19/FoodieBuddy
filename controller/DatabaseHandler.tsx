...
export const addFavourite = async (placeId: string) => {
  try {
    ...
    console.log("favouriteCollection", favouriteCollection);
 ...
 * @param placeId Maps API place id
 */
export const removeFavourite = async (uid: string, placeId: string) => {
  try {
    const favouriteCollection = `users/${uid}/favourites`;
 ...
 * @param placeId Maps API place id
 */
export const addBookmark = async (uid: string, placeId: string) => {
  try {
 ...
 * @param placeId Maps API place id
 */
export const removeBookmark = async (uid: string, placeId: string) => {
  try {
    const bookmarkCollection = `users/${uid}/bookmarks`;
